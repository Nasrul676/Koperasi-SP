...
<head>
    ...
    <link href="<?= base_url() ?>asset/js/sweetalert2.css" rel="stylesheet">
    <script href="<?= base_url() ?>asset/js/sweetalert2.all.min.js" rel="stylesheet"></script>
    ...
    <script href="<?= base_url() ?>asset/js/sweetalert2.js" rel="stylesheet"></script>
