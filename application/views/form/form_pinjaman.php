      ...
      <div class="card">
        ...
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <form action="<?= base_url('koperasi/form_pinjaman')?>" method="post">
              ...
              <div class="form-group">
                ...
                <input type="date" name="tanggal_pinjam" class="form-control" value="<?= set_value('tanggal_pinjam')?>">
                <?= form_error('date_created', '<small class="text-danger pl-3">', '</small>'); ?>
              </div>

              <div class="form-group">
                <label>Jumlah Pinjaman</label>
                <input type="text" name="jumlah_pinjaman" class="form-control" value="<?= set_value('jumlah_pinjaman')?>">
