      ...
      <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Simpanan Pokok</h1>
           ...
           <!-- <div class="row mt-3 my-3 ml-3">
             <div class="col-md-6">
              <div class="alert alert-success alert-dismissible fade show" role="alert">
                Simpanan Pokok <strong>Berhasil</strong> <?= $this->session->flashdata('message');?>
        ...
        <div class="row mx-3">
          <div class="col-md-6 mb-4">
            <a href="<?= base_url('koperasi/form_pokok')?>" class="btn btn-primary">Tambah Simpanan</a>
          </div>
        </div>
      ...
      <tbody>
        ...
        ?>
          <td><?= $no++  ?></td>
              ...
              <td><?= $agg->no_kk ?></td>
              <td><?= $agg->no_telp ?></td>
              <td>Rp <?php echo number_format($agg->simpanan_pokok,2,',','.')?></td>
              <td><?= $agg->alamat ?></td>
              <td><?= $agg->date_created ?></td>
              <td><?= $agg->status ?></td>
              <td>
                <a onclick="return confirm('yakin?');" class="badge badge-danger"<?php echo anchor('koperasi/hapuspokok/'.$agg->id,'Hapus'); ?></a>
                <a class="badge badge-primary"<?php echo anchor('koperasi/edit_pokok/'.$agg->id,'Edit'); ?></a>
              </td>
            </tr>
