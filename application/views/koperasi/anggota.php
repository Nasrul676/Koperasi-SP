        ...
        <li class="nav-item">
          ...
          <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <h1 class="h3 text-gray-800 ml-3">Anggota</h1>
               ...
               <!-- <div class="row mt-3 my-3">
                 <div class="col-md-6">
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Data Anggota<strong>Berhasil</strong> <?= $this->session->flashdata('message');?>
            ...
            <div class="row mx-3">
              <div class="col-md-6">
                <a href="<?= base_url('koperasi/tambah')?>" class="btn btn-primary">Tambah Anggota</a>
              </div>
            </div>
            ...
            <div class="col-lg mt-5">
              <ul class="list-group">
                <?php foreach($anggota as $agg) : ?>
                  <li class="list-group-item"><?= $agg['fname']; ?>
                  <a href="<?= base_url();?>Koperasi/hapus/<?= $agg['id'];?>" class="badge badge-danger float-right ml-2" onclick="return confirm('yakin?');">hapus</a>
                  <a href="<?= base_url();?>Koperasi/detail/<?= $agg['id'];?>" class="badge badge-primary float-right">detail</a>
                </li>
              <?php endforeach;?>
            </ul>
          </div>
