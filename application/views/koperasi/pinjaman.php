      ...
      <li class="nav-item">
        ...
        <li class="nav-item active">
          ...
          <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="h3 text-gray-800 ml-3">Pinjaman</h1>

            <div class="row mx-3">
              <div class="col-md-6 mb-4">
                <a href="<?= base_url('koperasi/form_pinjaman')?>" class="btn btn-primary">Tambah Pinjaman</a>
              </div>
            </div>
            ...
            <thead>
              ...
              foreach ($data as $agg) {
                ...
                <tr>
                  ...
                  <td><?= $agg->no_telp ?></td>
                  <td>Rp <?php echo number_format($agg->jumlah_pinjaman,2,',','.')?></td>
                  <td><?= $agg->alamat ?></td>
                  <td><?= $agg->tanggal_pinjam ?></td>
                  <td><?= $agg->status ?></td>
                  <td>
                    <a onclick="return confirm('yakin?');" class="badge badge-danger"<?php echo anchor('koperasi/hapuspinjaman/'.$agg->id,'Hapus'); ?></a>
                    
                    <a class="badge badge-success"<?php echo anchor('koperasi/pembayaran/'.$agg->id,'Bayar'); ?></a>
                  </td>
                </tr>
